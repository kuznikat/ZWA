...
if ($db_conn === null) {
    ...
    // Don't exit, just log - let the page display with error message
    error_log("Database connection failed in register.php: " . $db_error);
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['register'])) {
    ...
    $result = register_user($username, $email, $password, $avatar_file);

    if ($result['success']) {
        // Get user data to get avatar
        $user_data = get_user_data($result['user_id']);
        $avatar = $user_data['avatar'] ?? null;

        // Auto-login after registration
        login_user($result['user_id'], $username, 'authenticated', $avatar);
...
<body>
    ...
    <section class="booking">
        ...
        <?php if (isset($db_error)): ?>
            <div class="error-message">
                Database connection error: <?php echo escape($db_error); ?>
            </div>
        <?php endif; ?>
            ...
            <div class="flex">
                ...
                <div class="inputBox">
                    ...
                    <?php if (isset($errors['avatar'])): ?>
                        <span class="error-text"><?php echo escape($errors['avatar']); ?></span>
                    <?php endif; ?>
                </div>
            </div>
