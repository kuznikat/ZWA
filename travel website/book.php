   ...
   if (empty($errors)) {
      ...
      if ($conn === null) {
         ...
         try {
            ...
            // Note: user_id and tour_id are NULL for now (will be set when authentication is implemented)
            ...
            $stmt->execute([
               null, // user_id (NULL for unauthenticated users)
               null, // tour_id (NULL for now)
